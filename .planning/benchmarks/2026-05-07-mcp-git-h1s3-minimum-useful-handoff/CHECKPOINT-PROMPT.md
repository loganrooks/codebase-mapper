...
Review whether H1 clears the minimum-useful CBM floor. Write findings into `.planning/reviews/2026-05-07-h1-minimum-useful-checkpoint/CHECKPOINT.md` and leave the final decision in `.planning/reviews/2026-05-07-h1-minimum-useful-checkpoint/DISPOSITION.md`.
